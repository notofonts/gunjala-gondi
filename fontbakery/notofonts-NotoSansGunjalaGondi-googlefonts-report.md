...
</div></details><br></div></details><details><summary><b>[10] NotoSansGunjalaGondi[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Noto fonts must have an ARTICLE.en_us.html file (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/description/noto_has_article">com.google.fonts/check/description/noto_has_article</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, coptic, syriac, tifinagh, canadian-aboriginal, math, malayalam, old-permic
...
Or you can add the above codepoints to one of the subsets supported by the font: `gunjala-gondi`, `latin`, `latin-ext` [code: unreachable-subsetting]
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* sterling (U+00A3): X=249.0,Y=620.5 (should be at cap-height 622?)

	* copyright (U+00A9): X=152.5,Y=620.5 (should be at cap-height 622?)

	* copyright (U+00A9): X=675.5,Y=620.5 (should be at cap-height 622?)

	* registered (U+00AE): X=152.5,Y=620.5 (should be at cap-height 622?)

	* registered (U+00AE): X=675.5,Y=620.5 (should be at cap-height 622?)

	* Agrave (U+00C0): X=318.0,Y=624.0 (should be at cap-height 622?)

	* Aacute (U+00C1): X=318.0,Y=624.0 (should be at cap-height 622?)

	* Acircumflex (U+00C2): X=318.0,Y=624.0 (should be at cap-height 622?)

	* Atilde (U+00C3): X=318.0,Y=624.0 (should be at cap-height 622?)

	* Adieresis (U+00C4): X=318.0,Y=624.0 (should be at cap-height 622?)

	* Aring (U+00C5): X=318.0,Y=624.0 (should be at cap-height 622?)

	* germandbls (U+00DF): X=317.0,Y=-1.0 (should be at baseline 0?)

	* atilde (U+00E3): X=301.5,Y=621.0 (should be at cap-height 622?)
	...
	* ntilde (U+00F1): X=329.5,Y=621.0 (should be at cap-height 622?)

	* otilde (U+00F5): X=323.5,Y=621.0 (should be at cap-height 622?)
	...
	* Amacron (U+0100): X=318.0,Y=624.0 (should be at cap-height 622?)

	* Abreve (U+0102): X=318.0,Y=624.0 (should be at cap-height 622?)

	* Aogonek (U+0104): X=318.0,Y=624.0 (should be at cap-height 622?)
	...
	* tilde (U+02DC): X=243.5,Y=621.0 (should be at cap-height 622?)

	* tildecomb (U+0303): X=-287.5,Y=621.0 (should be at cap-height 622?)
	...
	* VowelU.GGondi (U+11D64): X=263.0,Y=2.0 (should be at baseline 0?)

	* VowelU.GGondi (U+11D64): X=263.0,Y=2.0 (should be at baseline 0?)

	* VowelUu.GGondi (U+11D65): X=205.0,Y=2.0 (should be at baseline 0?)

	* VowelEe.GGondi (U+11D67): X=696.0,Y=620.0 (should be at cap-height 622?)

	* VowelOo.GGondi (U+11D6A): X=696.0,Y=620.0 (should be at cap-height 622?)

	* Pha.GGondi (U+11D86): X=283.0,Y=2.0 (should be at baseline 0?)

	* Pha.GGondi (U+11D86): X=283.0,Y=2.0 (should be at baseline 0?)

	* MatraEe.GGondi (U+11D90): X=-102.0,Y=620.0 (should be at cap-height 622?)

	* MatraOo.GGondi (U+11D93): X=262.0,Y=620.0 (should be at cap-height 622?) [code: found-misalignments]
...
Your font does *not* cover the following languages that require the soft-dotted feature: Basaa (Latn, 332,940 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mango (Latn, 77,000 speakers), Dan (Latn, 1,099,244 speakers), Igbo (Latn, 27,823,640 speakers), Ma’di (Latn, 584,000 speakers), Kom (Latn, 360,685 speakers), Ejagham (Latn, 120,000 speakers), Sar (Latn, 500,000 speakers), Ebira (Latn, 2,200,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Navajo (Latn, 166,319 speakers), Koonzime (Latn, 40,000 speakers), Lugbara (Latn, 2,200,000 speakers), Avokaya (Latn, 100,000 speakers), Nateni (Latn, 100,000 speakers), Aghem (Latn, 38,843 speakers), Gulay (Latn, 250,478 speakers). [code: soft-dotted]
